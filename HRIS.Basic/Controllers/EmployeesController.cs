...
namespace HRIS.Basic.Controllers
{
    ...
    [ApiController]
    public class EmployeesController : ControllerBase, IEmployeesRepository
    {
        private readonly HrisDbRevContext _context;

        public EmployeesController(HrisDbRevContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Employee>> PostEmployee(Employee employee)
        {
          if (_context.Employees == null)
          {
              return Problem("Entity set 'HrisDbRevContext.Employees'  is null.");
          }
